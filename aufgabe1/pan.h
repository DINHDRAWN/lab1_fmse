...
#define PanSource	"treasurehunt-b.pml"
...
#define _nstates1	42	/* assistant */
#define minseq1	63
#define maxseq1	103
#define _endstate1	41

#define _nstates0	64	/* professor */
#define minseq0	0
#define maxseq0	62
...
#endif
	unsigned foundTrap : 1;
	uchar placeTrapX;
	uchar placeTrapY;
	uchar placeTrap;
} P2;
#define Air2	(sizeof(P2) - Offsetof(P2, placeTrap) - 1*sizeof(uchar))

#define Passistant	((P1 *)_this)
typedef struct P1 { /* assistant */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 3; /* proctype */
	unsigned _p   : 7; /* state    */
#ifdef HAS_PRIORITY
...
#define Air1	(sizeof(P1) - Offsetof(P1, _5_2_y) - 1*sizeof(uchar))

#define Pprofessor	((P0 *)_this)
typedef struct P0 { /* professor */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 3; /* proctype */
	unsigned _p   : 7; /* state    */
#ifdef HAS_PRIORITY
...
#endif
	uchar nextLocation;
	uchar assistantLocation;
	uchar nextLocationWord;
	uchar _4_1_x;
	uchar _4_1_y;
} P0;
#define Air0	(sizeof(P0) - Offsetof(P0, _4_1_y) - 1*sizeof(uchar))
